namespace BaseCom.Validacion
{
    ...
    {
        public const int C_CodigoErrorRegistroExistente = 9500;
        public const int NoErrror = 0;
        public const int GenericErrror = 1;
        ...
        public const int StringIsNull = 116;
        ...
        public const int DateIsNull = 403;
        public const int intIsNull = 404;
        public const int InvalidEmail = 500;
    }
}
